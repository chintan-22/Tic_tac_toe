...
int main()
{ int player = 1, i, choice; int invalidMove = 0;
char mark; do
{
board(); player = (player % 2) ? 1 : 2;
if(invalidMove == 1) { printf("Invalid move :(\nPlease try again.\n"); printf("Player %d, enter a number: ", player);
}
else
...
invalidMove = 0; i = checkwin(); player++;
}while (i == - 1);
board();
if (i == 1)
...
return 1;
else if (square[1] != '1' && square[2] != '2' && square[3] != '3' && square[4] != '4' && square[5] != '5' && square[6] != '6' && square[7]
...
void board()
{
system("clear"); printf("\tTic Tac Toe\n\n"); printf("Player 1 (X) - Player 2 (O)\n\n");
